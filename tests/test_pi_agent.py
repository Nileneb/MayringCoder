...
from mayring_pi_agent.pi import analyze_with_memory, run_task_with_memory, _execute_search_memory
...
class TestAnalyzeWithMemory:
    ...
    @patch("mayring_pi_agent.pi._execute_search_memory")
    @patch("mayring_pi_agent.pi.init_memory_db")
    @patch("mayring_pi_agent.pi.get_or_create_chroma_collection")
    @patch("httpx.post")
...
class TestExecuteSearchMemory:
    def test_returns_string(self):
        ...
        with patch("mayring_pi_agent.pi.search") as mock_search, \
             patch("mayring_pi_agent.pi.compress_for_prompt") as mock_compress:
